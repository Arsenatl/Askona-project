...
function ProductDetail() {
  ...
  return (
    <>
    <Helmet>
      <title>{`Karniz ${data?.name_uz.toLocaleLowerCase()}`}</title>
      <meta name="description" content={`karniz ${data?.name_uz.toLocaleLowerCase()} narxlari, karniz ${data?.name_uz.toLocaleLowerCase()} sotib olish, karniz ${data?.name_uz.toLocaleLowerCase()} fargona`} />
    </Helmet>
    <div>
      {isSuccess ? (
          ...
          <div className="flex flex-row desktop:gap-10 tablet:gap-0 mobile:gap-0">
            <div className='flex flex-col gap-12 desktop:w-[60%] tablet:w-full mobile:w-full'>
              <div className="mobile:hidden tablet:flex desktop:flex">
                ...
                <div className="w-[750px] h-[450px] border-2 border-solid border-gray-100 relative">
                  <div className="flex flex-col items-end absolute z-20 right-0">
                    <p className="rounded w-[max-content] bg-[#4FB7FF] px-2 py-1 text-white">
              ...
              <div className="bg-[#F6F6F6] py-6 px-8 divide-y flex flex-col">
                <h2 className='font-extrabold text-2xl mb-3'>{lang === 'ru' ? 'Характеристики' : 'Xususiyatlari'}</h2>
                <div className={`${data.brend ? 'flex justify-between items-center py-3' : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Бренд' : 'Brend'}</h3>
                  <p className='text-black font-medium desktop:text-base tablet:text-sm mobile:text-sm'>{data.brend}</p>
                </div>
                <div className="flex justify-between items-center py-3">
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Происхождения' : 'Ishlab chiqarilgan'}</h3>
                ...
                <div className="flex justify-between items-center py-3">
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Тип' : 'Turi'}</h3>
                  <p className='text-black font-medium desktop:text-base tablet:text-sm mobile:text-sm'>{lang === 'ru' ? data.type_ru : data.type_uz}</p>
                </div>
                <div className="flex justify-between items-center py-3">
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Единица измерения' : 'Birlik o`lchovlari'}</h3>
                ...
                <div className="flex justify-between items-center py-3">
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Материал' : 'Material'}</h3>
                ...
                <div className="flex justify-between items-center py-3">
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Вес в упаковке, кг' : 'Qadoq og`irligi, kg'}</h3>
                  <p className='text-black font-medium desktop:text-base tablet:text-sm mobile:text-sm'>{data.package_weighte}</p>
                </div>
                <div className="flex justify-between items-center py-3">
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Размер в упаковке, Длина, см' : 'Qadoqdagi olchamlari, Uzunligi, sm'}</h3>
                  <p className='text-black font-medium desktop:text-base tablet:text-sm mobile:text-sm'>{data.package_length_sm}</p>
                </div>
                <div className="flex justify-between items-center py-3">
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Размер в упаковке, Высотаб см' : 'Qadoq olchamlari, Balandligi, sm'}</h3>
                  <p className='text-black font-medium desktop:text-base tablet:text-sm mobile:text-sm'>{data.package_heigt_sm}</p>
                </div>
                <div className="flex justify-between items-center py-3">
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Емкость' : 'Sig`imi'}</h3>
                ...
                <div className={`${data.shaped_ru ? 'flex justify-between items-center py-3' : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Форма' : 'Forma'}</h3>
                ...
                <div className={`${data.method_of_sale_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Метод продаж' : 'Sotish usuli'}</h3>
                ...
                <div className={`${data.diameter_sm ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Диаметр' : 'Diamteri'}</h3>
                ...
                <div className={`${data.length ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Длина' : 'Uzunligi'}</h3>
                ...
                <div className={`${data.characteristics_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Характеристики' : 'Xususiyatlari'}</h3>
                ...
                <div className={`${data.style_uz ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Стиль' : 'Uslub'}</h3>
                ...
                <div className={`${data.Type_of_curtain_accessories_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Тип аксессуаров для штор' : 'Pardalar uchun aksessuarlar turi'}</h3>
                ...
                <div className={`${data.CN_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'CN' : 'CN'}</h3>
                  <p className='text-black font-medium desktop:text-base tablet:text-sm mobile:text-sm'>{lang === 'ru' ? data.CN_ru : data.CN_uz}</p>
                </div>
                <div className={`${data.Method_of_sale_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Cпособ продажи' : 'Sotish usuli'}</h3>
                  <p className='text-black font-medium desktop:text-base tablet:text-sm mobile:text-sm'>{lang === 'ru' ? data.Method_of_sale_ru : data.Method_of_sale_uz}</p>
                </div>
                <div className={`${data.individual_production ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Индивидуальное производство' : 'Individual ishlab chiqarish'}</h3>
                ...
                <div className={`${data.certification_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Cертификат' : 'Sertifikat'}</h3>
                ...
                <div className={`${data.appropriate_curtain_type ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Подходящий тип штор' : 'Tegishli parda turi'}</h3>
                ...
                <div className={`${data.cornice_width ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Ширина карниза' : 'Karniz olchami'}</h3>
                ...
                <div className={`${data.baguette_width ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Ширина багета' : 'Baget olchami'}</h3>
                ...
                <div className={`${data.cornice_type_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Карнизный тип' : 'Karniz turi'}</h3>
                ...
                <div className={`${data.suspension_type_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Тип подвески' : 'Oqibat turi'}</h3>
                ...
                <div className={`${data.tip_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Совет' : 'Maslahat'}</h3>
                ...
                <div className={`${data.rotation_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Поворот' : 'Aylanish'}</h3>
                ...
                <div className={`${data.completely_finished_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Завершенность' : 'Tugallanish'}</h3>
                ...
                <div className={`${data.cover_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Крышка' : 'Qopqa'}</h3>
                ...
                <div className={`${data.the_length_of_the_sprayer_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Длина распылителя' : 'Sprayer uzunligi'}</h3>
                ...
                <div className={`${data.hose_length_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Длина шланга' : 'Shlang uzunligi'}</h3>
                ...
                <div className={`${data.total_weight_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Общий вес' : 'Jami og\'irligi'}</h3>
                ...
                <div className={`${data.container_capacity_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Емкость бака' : 'Konteyner sig\'imi'}</h3>
                ...
                <div className={`${data.work_expenses_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Расходы на работу' : 'Ish xarajatlari'}</h3>
                ...
                <div className={`${data.adjusting_the_sprayer_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Настройка распылителя' : 'Sprayer sozlashi'}</h3>
                ...
                <div className={`${data.status_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Cтатус' : 'Status'}</h3>
                ...
                <div className={`${data.how_to_transport_the_sprayer_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Как транспортировать опрыскиватель' : 'Purkagichni qanday tashish kerak'}</h3>
                ...
                <div className={`${data.spray_type_ru ? "flex justify-between items-center py-3" : 'hidden'}`}>
                  <h3 className='font-semibold desktop:text-lg tablet:text-base mobile:text-base'>{lang === 'ru' ? 'Cпрей тип' : 'Spray turi'}</h3>
              ...
              <div className="desktop:w-[800px] tablet:w-full mobile:w-full flex flex-col gap-5">
                <h3 className='font-extrabold text-2xl'>{lang === 'ru' ? 'Описание' : 'Tavsif'}</h3>
